...
if(NOT "include " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'styx' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/student/Desktop/SelfDrivingCarND_SystemIntegration/ros/install/${idir}'.  Ask the maintainer 'yousuf <yousuf@todo.todo>' to fix it.")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/student/Desktop/SelfDrivingCarND_SystemIntegration/ros/install/lib;/home/student/Desktop/SelfDrivingCarND_SystemIntegration/ros/devel/lib;/opt/ros/kinetic/lib)
