...
(cl:defmethod cl:initialize-instance :after ((m <ChangeTargetSpeed-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'ChangeTargetSpeed-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name styx_msgs-srv:<ChangeTargetSpeed-request> is deprecated: use styx_msgs-srv:ChangeTargetSpeed-request instead.")))

(cl:ensure-generic-function 'target_speed-val :lambda-list '(m))
(cl:defmethod target_speed-val ((m <ChangeTargetSpeed-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader styx_msgs-srv:target_speed-val is deprecated.  Use styx_msgs-srv:target_speed instead.")
  (target_speed m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<ChangeTargetSpeed-request>)))
  ...
  "styx_msgs/ChangeTargetSpeedRequest")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'ChangeTargetSpeed-request)))
  "Returns string type for a service object of type 'ChangeTargetSpeed-request"
  "styx_msgs/ChangeTargetSpeedRequest")
...
(cl:defmethod cl:initialize-instance :after ((m <ChangeTargetSpeed-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'ChangeTargetSpeed-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name styx_msgs-srv:<ChangeTargetSpeed-response> is deprecated: use styx_msgs-srv:ChangeTargetSpeed-response instead.")))

(cl:ensure-generic-function 'feedback-val :lambda-list '(m))
(cl:defmethod feedback-val ((m <ChangeTargetSpeed-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader styx_msgs-srv:feedback-val is deprecated.  Use styx_msgs-srv:feedback instead.")
  (feedback m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<ChangeTargetSpeed-response>)))
  ...
  "styx_msgs/ChangeTargetSpeedResponse")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'ChangeTargetSpeed-response)))
  "Returns string type for a service object of type 'ChangeTargetSpeed-response"
  "styx_msgs/ChangeTargetSpeedResponse")
